...
- (void) loadStyleViewBlue {
    self.backgroundColor = [[UIColor alloc] initWithRed: 60.f/255.f green: 154.f/255.f blue: 223.f/255.f alpha: 1];
}

- (void) loadStyleViewRoundedBorders {
    self.layer.masksToBounds = YES;
...
- (void) loadStyleLabelExample {
    self.textColor = [UIColor whiteColor];
    self.backgroundColor = [UIColor clearColor];
    self.font = [UIFont boldSystemFontOfSize:16];
}

- (void) loadStyleViewClear {
    self.backgroundColor = [UIColor clearColor];
}
@end
