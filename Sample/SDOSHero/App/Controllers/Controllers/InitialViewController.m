...
#define VERSION_STR_FORMAT NSLocalizedString(@"SDOSHeroExample.version", @"")
#define GO_BACK_BUTTON_TITLE @"<"
#define GO_FORWARD_BUTTON_TITLE @">"


@interface InitialViewController () <WKNavigationDelegate>
...
- (IBAction)actionShowExample {
    UIViewController *vc = [self.storyboard instantiateViewControllerWithIdentifier:SDOSHeroNavigationControllerIdentifier];
