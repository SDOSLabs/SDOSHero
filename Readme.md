...
En el siguiente paso deberemos seleccionar la versión que queremos instalar. Recomentamos indicar "Up to Next Major" `3.1.2`.
...
``` swift
dependencies: [
    .package(url: "https://github.com/SDOSLabs/SDOSHero.git", .upToNextMajor(from: "3.1.2"))
]
```
